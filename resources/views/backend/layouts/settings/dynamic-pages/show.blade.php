            ...
            <div class="card">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="text-end mt-4">
                        <a href="{{ route('dynamic_page.index') }}" class="btn btn-secondary px-4">Back to List</a>
                        <a href="{{ route('dynamic_page.edit', $page->id) }}" class="btn btn-primary px-4 ms-2">Edit Page</a>
                    </div>
                </div>
